function [x, out] = ssmNewtonL1Pen_proj(A,At,b,N,mu,opts)
...
if ~isfield(opts,'CG_tol');   opts.CG_tol = 1e-2;   end
...
if ~isfield(opts,'eta1');     opts.eta1 = 0.2;   end
...
if ~isfield(opts,'lambda');   opts.lambda = 0.2;    end %adjust mu
